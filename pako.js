...
const GZIP = "eyJhbGciOiJIUzUxMiIsInppcCI6IkdaSVAifQ.H4sIAAAAAAAAAKtWKi5NUrJScspPUqoFAFeQcd0NAAAA._sVpeCpoIxjC0kLhzNYv3I2OlUFcAdwCRrcnymZzh9fwCUP38ZhTMUK8D1 - q5RUFgEXzuuXE7wTPEANhlCB2bQ";
const DEFLATE = "eyJhbGciOiJIUzUxMiIsInppcCI6IkRFRiJ9.eNqqViouTVKyUnLKT1KqBQAAAP__.aFSN9mvH0Qwyb7eKFITyYxifkPrexINWPyhB8IF34RCuQ - w7hjBkun2z29lxlWSw5r56dQNOSj8spZgBMBITCQ";
const UNICODE = "eyJhbGciOiJIUzUxMiIsInppcCI6IkRFRiJ9.eNqqViouTVKyUjrcAoFKOkqZiSVKVoamJmYGBhYWRiY6SqkVBTABS3Mjk1oAAAAA__8.ghuu0RnahVcl8cqr_aufewRYBDIaDvbSFweAtlZaL3oe2A47ijf3mrb0qV2s6jnBSQk36_--knXNGbryPQrLbA";
...
const replace = UNAUTH.replace(/-/g, "+").replace(/_/g, "/");
const split = replace.split(".");
const decoded = split.map(b => _atob(b));
